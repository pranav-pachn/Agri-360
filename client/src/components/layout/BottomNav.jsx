...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 lg:hidden bg-[#060e1a]/90 backdrop-blur-xl flex justify-around items-center px-4 pb-6 pt-3 shadow-[0_-4px_20px_rgba(0,0,0,0.3)] rounded-t-3xl border-t border-slate-800">
          ...
          <Link
            ...
            className={`flex flex-col items-center justify-center rounded-2xl px-5 py-2 transition-all duration-100 text-center ${
              isActive
                ...
                : 'text-slate-500 active:bg-slate-800 active:scale-90'
            }`}
          >
