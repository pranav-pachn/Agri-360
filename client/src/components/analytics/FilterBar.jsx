...
const FilterBar = ({
  ...
  const stateOptions = ['All', ...states.filter(Boolean)];
  const districtOptions = ['All', ...districts.filter(Boolean)];
  ...
  return (
    <div className="flex flex-wrap justify-between items-center gap-4 bg-slate-800 p-4 rounded-xl border border-slate-700">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="text-slate-300 text-sm font-medium whitespace-nowrap">Filters:</span>
