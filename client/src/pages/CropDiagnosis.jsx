			...
			<div className="page-wrapper">
				<div className="page-inner">
					<header className="hero-panel space-y-5">
						...
						<h1 className="page-title">Diagnosis &amp; Recovery</h1>
						...
						<section className="space-y-5 xl:col-span-4">
							<div className="card space-y-4">
								<div className="mb-4 flex items-center gap-3">
									<div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 text-xs font-bold text-slate-950">1</div>
									<h2 className="text-2xl font-semibold tracking-tight text-white">Capture &amp; Upload</h2>
								</div>
								{!previewURL ? (
							...
							<div className="card">
								<div className="mb-4 flex items-center justify-between">
									<h3 className="text-xs font-bold uppercase tracking-[0.18em] text-gray-400">Inference Engine</h3>
									<span className="rounded-full border border-emerald-300/20 bg-emerald-500/10 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.1em] text-emerald-200">
										Active
									</span>
								</div>
							...
							<div className="card space-y-4">
								<div>
									...
									<input
										...
										className="w-full rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-400/40"
									/>
						...
						<section className="space-y-6 xl:col-span-8">
							<div className="overflow-hidden card p-0">
								<div className="grid grid-cols-1 lg:grid-cols-2">
									<div className="relative min-h-[300px] bg-slate-900/80">
										{previewURL ? (
											<img src={previewURL} alt="Leaf diagnosis sample" className="h-full w-full object-cover" />
										) : (
											<div className="flex h-full min-h-[300px] items-center justify-center px-6 text-center text-gray-400">
									...
									<div className="p-6 lg:p-7">
										{!analysisResult ? (
											<div className="flex h-full flex-col justify-center">
												<p className="text-[11px] font-bold uppercase tracking-[0.18em] text-gray-400">Awaiting Diagnosis</p>
												<h2 className="mt-2 text-2xl font-black tracking-tight text-white">Run analysis to generate recovery plan</h2>
											...
											<>
												...
												<h2 className="mt-1 text-3xl font-black tracking-tight text-white">{analysisResult.disease}</h2>
												<div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
													<div className="card-compact rounded-2xl bg-slate-900/60 p-4">
